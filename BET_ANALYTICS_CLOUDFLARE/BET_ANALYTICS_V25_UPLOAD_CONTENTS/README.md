# BET ANALYTICS V25 — Major Men's Leagues + Calibration
...
## Correctif V25
Le parser reconnaît désormais les titres de ligue Maçkolik présents dans les attributs image `alt/title` et corrige automatiquement l’encodage turc Windows-1254.
