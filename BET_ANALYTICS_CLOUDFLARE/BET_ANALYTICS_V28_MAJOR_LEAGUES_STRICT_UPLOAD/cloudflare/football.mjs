export const PARSER_VERSION='28.0.0';
...
async function fetchText(url){
  try{
    const r=await fetch(url,{headers:{'user-agent':'Mozilla/5.0 (compatible; BET-ANALYTICS/28.0; +https://bet-analytics.ckenduz.workers.dev)','accept':'text/html,application/xhtml+xml'}});
