...
## V23 — politique compétitions
La liste n'est plus limitée à 13 ligues. `/api/football` conserve les grandes compétitions masculines trouvées sur Maçkolik et affiche leur libellé Maçkolik. Féminin, jeunes, réserves et divisions inférieures sont rejetés. Le parseur réinitialise aussi le contexte sur chaque nouveau titre afin d'éviter les faux rattachements de ligue.
